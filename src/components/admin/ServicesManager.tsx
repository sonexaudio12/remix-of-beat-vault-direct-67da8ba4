...
export function ServicesManager() {
  ...
  return <div className="space-y-6">
      ...
      {(creating || editing) && <div className="rounded-xl border border-border bg-card p-6 space-y-4">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div className="space-y-2">
              <Label>Price ($)</Label>
              <Input type="number" value={form.price} onChange={e => setForm(p => ({
            ...p,
            ...
            <div className="space-y-2">
              ...
              <Input type="number" value={form.sort_order} onChange={e => setForm(p => ({
            ...p,
      ...
      <div className="space-y-2">
        {services.map(s => <div key={s.id} className="flex items-center justify-between p-4 rounded-xl border border-border bg-card text-secondary-foreground">
