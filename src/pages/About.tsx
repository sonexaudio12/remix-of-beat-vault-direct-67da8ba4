    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <p className="text-muted-foreground text-lg mb-6">
          Sonex is a modern beat marketplace and creative platform developed
        ...
        <p className="text-muted-foreground mb-8">
          Built by producers, for producers and artists, Sonex was created
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <div className="rounded-xl border border-border bg-card p-6">
            <h3 className="font-semibold mb-2">Why Sonex Exists</h3>
            <p className="text-sm text-muted-foreground">
              Traditional beat stores focus on volume. Sonex focuses on
        ...
        <div className="mt-10 rounded-xl border border-border bg-secondary/40 p-6">
          ...
          <p className="text-sm text-muted-foreground">
            Sonex aims to become more than a marketplace. Our vision is to
