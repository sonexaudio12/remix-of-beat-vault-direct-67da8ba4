        ...
        <section className="py-16 md:py-24 relative overflow-hidden">
          ...
          <div className="container relative">
            <div className="max-w-2xl mx-auto text-center bg-[sidebar-primary-foreground] bg-background">
              <h1 className="font-display text-4xl md:text-5xl font-bold mb-4">Simple, Transparent Licensing</h1>
              <p className="text-lg text-muted-foreground">
                Choose the license that fits your project. All licenses include instant digital delivery and a PDF with
                your usage rights.
              </p>
            </div>
          </div>
        ...
        <section className="py-16 md:py-24">
          <div className="container bg-background">
            <div className="grid gap-8 md:grid-cols-3 max-w-6xl mx-auto bg-background">
              ...
              return <div key={license.name} className={`relative flex flex-col rounded-2xl border-2 p-6 md:p-8 transition-all bg-background ${colorClass} ${license.popular ? "md:-mt-4 md:mb-4 shadow-glow" : ""}`}>
                    ...
                    <div className={`text-4xl font-bold mb-4 text-${license.color}`}>{license.price}</div>
