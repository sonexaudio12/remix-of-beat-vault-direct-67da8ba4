...
const licenses = [
  ...
  },
  {
    ...
    useCases: [
      { icon: Radio, label: 'Radio Play' },
      { icon: Users, label: 'Live Performances' },
    ],
    popular: true,
  },
  {
    ...
    useCases: [
      { icon: Mic, label: 'Major Releases' },
      { icon: Globe, label: 'Commercial Use' },
    ],
  },
];
          ...
          <div className="container">
            <div className="grid gap-8 md:grid-cols-3 max-w-6xl mx-auto">
              {licenses.map((license) => {
                ...
                const colorClass = license.color === 'primary' 
                ...
                return (
                  <div
                    key={license.name}
                    className={`relative flex flex-col rounded-2xl border-2 p-6 md:p-8 transition-all bg-card ${colorClass} ${
