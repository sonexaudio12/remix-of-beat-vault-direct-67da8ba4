  ...
  return <div className="min-h-screen flex items-center justify-center bg-background px-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="rounded-2xl border border-border bg-card p-8">
          {isVerifying ? <div className="text-center space-y-4">
              <Loader2 className="h-12 w-12 animate-spin text-primary mx-auto" />
              <h1 className="font-display text-2xl font-bold">Verifying Link</h1>
              <p className="text-muted-foreground text-sm">Please wait…</p>
            </div> : verifyError ? <div className="text-center space-y-4">
            ...
            </div> : isSuccess ? <div className="text-center space-y-4">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <Lock className="absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-muted-foreground" />
                    <Input id="confirm" type={showPassword ? 'text' : 'password'} placeholder="••••••••" value={confirmPassword} onChange={e => {
                  setConfirmPassword(e.target.value);
                  if (errors.confirm) setErrors(p => ({
                    ...p,
                    confirm: undefined
                  }));
